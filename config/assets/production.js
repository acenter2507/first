  ...
  client: {
    lib: {
      ...
      js: [
        ...
        'public/lib/angular-strap/dist/angular-strap.compat.min.js',
        'public/lib/angular-aria/angular-aria.min.js',
        'public/lib/angular-material/angular-material.min.js',
        'public/lib/angular-ui-switch/angular-ui-switch.min.js',
        'public/lib/angular-elastic/elastic.min.js',
        'public/lib/angular-webstorage/angular-webstorage.min.js',
        ...
        'public/lib/textAngular/dist/textAngularSetup.min.js',
        'public/lib/angular-toastr/dist/angular-toastr.tpls.min.js',
        'public/lib/ng-dialog/js/ngDialog.min.js',
        'public/lib/angucomplete-alt/angucomplete-alt.min.js',

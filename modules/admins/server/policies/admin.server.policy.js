...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    ...
    allows: [{
      ...
      resources: '/api/admins/users/:aduserId/reported',
      permissions: '*'
    }, {
      resources: '/api/admins/users/:aduserId/picture',
      permissions: '*'
    }, {
      ...
      resources: '/api/admins/users/:aduserId/cmts',
      permissions: '*'
    }, {
      resources: '/api/admins/users/:aduserId/votes',
      permissions: '*'
    }, {

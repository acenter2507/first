...
describe('Category CRUD tests', function () {
          ...
          .end(function (categorySaveErr, categorySaveRes) {
            ...
            agent.get('/api/categorys')
              .end(function (categorysGetErr, categorysGetRes) {
                ...
                // Get Categorys list
                var categorys = categorysGetRes.body;

                // Set assertions
                (categorys[0].user._id).should.equal(userId);
                (categorys[0].name).should.match('Category name');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/categorys')
          ...
          .end(function (categorySaveErr, categorySaveRes) {
            ...
            agent.put('/api/categorys/' + categorySaveRes.body._id)
              .send(category)
              .expect(200)
  ...
  it('should be able to get a list of Categorys if not signed in', function (done) {
  ...
  it('should be able to get a single Category if not signed in', function (done) {
    ...
    // Save the Category
    categoryObj.save(function () {
      request(app).get('/api/categorys/' + categoryObj._id)
        .end(function (req, res) {
          // Set assertion
  ...
  it('should return proper error for single Category with an invalid Id, if not signed in', function (done) {
    ...
    request(app).get('/api/categorys/test')
      .end(function (req, res) {
        // Set assertion
  ...
  it('should return proper error for single Category which doesnt exist, if not signed in', function (done) {
    ...
    request(app).get('/api/categorys/559e9cd815f80b4c256a8f41')
      .end(function (req, res) {
        // Set assertion
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/categorys')
          ...
          .end(function (categorySaveErr, categorySaveRes) {
            ...
            agent.delete('/api/categorys/' + categorySaveRes.body._id)
              .send(category)
              .expect(200)
  ...
  it('should not be able to delete an Category if not signed in', function (done) {
    ...
    categoryObj.save(function () {
      ...
      request(app).delete('/api/categorys/' + categoryObj._id)
        .expect(403)
        .end(function (categoryDeleteErr, categoryDeleteRes) {
          // Set message assertion
              ...
              orphan.remove(function () {
                ...
                agent.post('/api/auth/signin')
                  ...
                  .end(function (err, res) {
                    ...
                    // Get the Category
                    agent.get('/api/categorys/' + categorySaveRes.body._id)
                      .expect(200)

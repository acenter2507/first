...
var adminPolicy = require('../policies/admin-users.server.policy'),
  admin = require('../controllers/admin-users.server.controller');
...
module.exports = function (app) {
  ...
  app.route('/api/admins/users/:page/:sort').get(adminPolicy.isAllowed, admin.loadAdminUsers);
  ...
  app.route('/api/admins/users/:aduserId/logins').get(adminPolicy.isAllowed, admin.users_logins);

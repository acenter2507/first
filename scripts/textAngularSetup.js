        ...
        function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, $log, $translate, dialog) {
            ...
            taRegisterTool('insertImage', {
                ...
                action: function () {
                    ...
                    dialog.openConfirm({
                        templateUrl: "<p ng-init=\"url = 'https://'\">{{:: 'LANGUAGE' | translate }}<p><input ng-model=\"url\" class=\"form-control\"><br /><button class=\"btn btn-primary\" ng-click=\"confirm(url)\"></button>",
                        plain: true
                    }).then(confirm => {
                        console.log(confirm);
                        imageLink = confirm;
